...
'''
GenerateCMPs accesses a .csv sheet (StockwithCMPs) with columns = [Slno, Symbol, Company]
and generates the CMP of each company and saves it to another .csv file.

Don't need to use it as I already have the data recorded in StockwithCMPS.
'''
